...
|---|---|---|---|---|
| Table I | 方法组件与创新角色 | `docs/pia_ca_llso_formal_method_zh.md`、`docs/pia_ca_llso_core_innovations_zh.md`、`docs/pia_capm_distance_research_zh.md` | 概括 CAPM-Distance、classifier_level_hybrid、active_uncertainty_diversity、`pia-evolve` 和 boundary audit 的角色 | 方法表，不是性能表 |
