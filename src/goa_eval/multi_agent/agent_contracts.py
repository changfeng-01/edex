...
def get_agent_contracts() -> dict[str, AgentContract]:
    return {
        ...
        "CriticAgent": AgentContract(
            ...
            allowed_tools=["check_schema_and_boundary", "inspect_candidates", "inspect_netlist_integrity"],
            input_schema=["shared_state", "tool_results", "handoff_records"],
            output_schema=["critic_verdicts", "warnings", "failures", "severity", "risk_type", "risks"],
        ...
        "ReportAgent": AgentContract(
            ...
            output_schema=["multi_agent_decision_report", "optimization_loop_record", "optimization_decision_card"],
